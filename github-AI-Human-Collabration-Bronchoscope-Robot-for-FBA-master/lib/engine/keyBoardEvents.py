...
def getAddition(keys, scale):
    ...
    botton_add_dict = {"k" : yaw_add,
                        "u" : pitch_add,  
                        "r" : x_add,
                        "y" : y_add,
                        "f" : z_add}
    botton_minus_dict = {"h" : yaw_add,
                            "j" : pitch_add,
                            "e" : x_add,
                            "l" : y_add,
                            "d" : z_add}
    ...
    yaw_add = botton_add_dict["k"] + botton_minus_dict["h"]
    pitch_add = botton_add_dict["u"] + botton_minus_dict["j"]
    x_add = (botton_add_dict["r"] + botton_minus_dict["e"]) * scale
    y_add = (botton_add_dict["y"] + botton_minus_dict["l"]) * scale
    z_add = (botton_add_dict["f"] + botton_minus_dict["d"]) * scale
    
    return yaw_add, pitch_add, x_add, y_add, z_add


def getAdditionCV(key, scale):
    ...
    pitch_add = botton_add_dict["u"] + botton_minus_dict["j"]
    x_add = (botton_add_dict["r"] + botton_minus_dict["e"]) * scale
    y_add = (botton_add_dict["i"] + botton_minus_dict["y"]) * scale
    z_add = (botton_add_dict["f"] + botton_minus_dict["d"]) * scale
    along_add = (botton_add_dict["v"] + botton_minus_dict["c"])
    
    return yaw_add, pitch_add, x_add, y_add, z_add, along_add
